 ...
 */
public class TripManagementPresenterImpl implements TripManagementPresenter{

    private View mView;

    public TripManagementPresenterImpl(View mView) {
        this.mView = mView;
    }

    @Override
    public void getTripManagement(final Map<String, String> queryRequest) {
        KangenDesaApp.getInstance().service(new ServiceInterface() {
            ...
            public void responseSuccess(Response<BaseResponse> response) {
                try {
                    ...
                    mView.showTripManagement(itemTourByUsers, Integer.valueOf(totalData));
