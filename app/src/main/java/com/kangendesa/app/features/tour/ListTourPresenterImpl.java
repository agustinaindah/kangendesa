 ...
 */
public class ListTourPresenterImpl implements ListTourPresenter {

    private View mView;

    public ListTourPresenterImpl(View mView) {
        this.mView = mView;
    }

    @Override
    public void getListTour(final Map<String, String> queryRequest) {
        KangenDesaApp.getInstance().service(new ServiceInterface() {
            @Override
            public Call<BaseResponse> callBackResponse(ApiService apiService) {
                return apiService.getListTour(queryRequest);
            }
            ...
            public void responseSuccess(Response<BaseResponse> response) {
                try {
                    ...
                    mView.showListTour(itemTours, Integer.valueOf(totalData));
